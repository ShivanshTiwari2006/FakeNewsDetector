  ...
  return (
    <nav className="navbar">
      <div className="navbar-logo">
        ...
        <span className="logo-text">Fake News Detector</span>
      </div>
      <ul className="navbar-links">
        ...
        <li>
          <Link to="/fun-game" className={location.pathname === '/FunGame' ? 'active' : ''}>Fun Game</Link>
        </li>
        <li>
          <Link to="/jobs" className={location.pathname === '/jobs' ? 'active' : ''}>About Us</Link>
        </li>
